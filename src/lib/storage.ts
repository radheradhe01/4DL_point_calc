...
function dbRowToLobby(row: any, teams: Team[], matches: Match[]): Lobby {
  return {
    ...
    prizeMoney: row.prize_money || undefined,
    ...
    pointsTemplate: row.points_template || undefined,
...
export async function saveLobby(lobby: Lobby): Promise<void> {
  try {
    ...
    const lobbyData = {
      ...
      prize_money: lobby.prizeMoney || null,
      ...
      points_template: lobby.pointsTemplate || null,
